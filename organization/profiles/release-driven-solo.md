...
tool-qr-generator の current release-driven development で使用する Operating Model を定義します。
...
- QR encoding/output correctness is product behavior and should be verified with representative payloads, not inferred from UI rendering alone.
